...
* [getUserPlatform](https://github.com/Zerfo/utils/tree/master/src/getUserPlatform/getUserPlatform.ts) - Сhecks the userAgent of the user's browser and returns the platform used.
